...
const products = [
  ...
  const currentDescription=document.querySelector(".productDescription");
...
menuItem.forEach((item,index)=>{
    item.addEventListener("click",()=>{
        ...
        // currentColor.textContent=choosenProduct.colors;
        // currentDescription.textContent=choosenProduct.des
        // currentSize.textContent=choosenProduct.size;
